            ...
            <aside class="sidebar" class:sidebar-open=move || sidebar_open.get()>
                ...
                <nav class="nav">
                    <ul class="nav-list">
                        ...
                        <li class="nav-item">
                            <A href="/plugins" attr:class="sidebar-link" on:click=close_sidebar>
                                <span class="sidebar-link-icon">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                                ...
                                <span class="sidebar-link-label">"Plugins"</span>
                            </A>
                        </li>
                        <li class="nav-item">
                            <A href="/tasks" attr:class="sidebar-link" on:click=close_sidebar>
                                <span class="sidebar-link-icon">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                                        <circle cx="12" cy="12" r="10"/>
