...
| [ADR-002](./ADR-002-gemini-cli-support-evaluation.md) | Gemini CLI Support Evaluation | Closed | 2026-02-12 | Evaluation of Gemini CLI v0.28.2 support — closed 2026-03-30 with Option C (ADR-001 maintained). Re-evaluation triggered by 50+ GitHub requests or confirmed team adoption. |
